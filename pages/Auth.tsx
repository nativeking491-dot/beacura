...
import { Heart, Mail, Lock, User, ArrowRight, Loader2, AlertCircle, Eye, EyeOff, Sparkles } from 'lucide-react';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isLogin) {
                ...
                const { user } = await authService.signUp(email, password, name, selectedRole);
            ...
            } else if (err.message.includes('Invalid login') || err.message.includes('Incorrect password')) {
