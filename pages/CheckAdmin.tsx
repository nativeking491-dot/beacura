  ...
  return (
    <div className="p-8 bg-white rounded-lg shadow-lg max-w-2xl mx-auto mt-8">
      ...
      <div className="space-y-3">
        ...
        <div
          className={`p-4 rounded-lg ${info.isAdmin ? "bg-green-100 border-2 border-green-500" : "bg-red-100 border-2 border-red-500"}`}
        >
          ...
          <ol className="list-decimal ml-5 space-y-2">
            ...
            <li>
              ...
              <code className="bg-slate-200 px-2 py-1 rounded">
                UPDATE users SET role = 'ADMIN' WHERE email = '{info.email}';
              </code>
            </li>
